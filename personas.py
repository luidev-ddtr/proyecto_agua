...
class Persona:
    ...
    def __init__(self, formateador, datos_prueba=True):
        ...
        if datos_prueba:
            ...
            self.nombre = "Monserrat"
            self.apellidos = "Else if"
            self.estado_especial = "ninguno"
            self.manzana = "Yondha"
            self.estudia = 0
            self.fecha_nac = ("1961-11-01")
            self.edad = self.calculate_age()
            self.activo = self.is_active(self.edad)
    ...
    def is_active(self, edad):
        ...
        try:
            ...
            if (18 <= edad <= 65) and self.estado_especial.lower() == "ninguno" and (not estudia):
                return True
            return False
...
Los datos deben de introducirse en este formato 
        ...
        if datos_prueba:
            # Inicializar con datos de prueba
            self.nombre = "Rianu"
            self.apellidos = "Pérez Gomez"
            self.estado_especial = "Madre soltera"
            self.manzana = "M1 Grant"
            self.estudia = 1 o bool
            self.fecha_nac = ("1990-05-15")
            self.edad = self.calculate_age()
            self.activo = self.is_active(self.edad)
